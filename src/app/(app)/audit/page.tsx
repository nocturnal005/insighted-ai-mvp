...
const ACTION_LABEL: Record<string, string> = {
  ...
  "transcription.correction.record": "recorded specialist correction evidence for",
  "transcription.review_item.confirmed": "confirmed machine interpretation for",
  "transcription.review_item.corrected": "corrected a transcription passage for",
  "transcription.review_item.needs_rescan": "requested a re-scan for",
  ...
  "feedback.subject_assess": "recorded subject-content assessment for",
